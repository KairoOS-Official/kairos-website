    ...
    this.innerHTML = `
      <footer class="w-full bg-white border-t border-slate-200/80 pt-16 pb-12 mt-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-8">
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 pb-12 border-b border-slate-200/70">
            ...
            <div class="lg:col-span-2 space-y-4">
              <div class="flex items-center gap-3">
                <div class="w-8 h-8 rounded-xl bg-slate-900 flex items-center justify-center p-1.5 shadow-sm">
                  <img alt="Kairo Logo" class="w-full h-full object-contain filter invert" 
              ...
              <div class="flex items-center gap-2 text-xs font-mono text-slate-500">
                ...
                <span data-en="MIT License · 100% Open Source" data-fr="Licence MIT · 100% Open Source">Licence MIT · 100% Open Source</span>
              </div>
            </div>
          ...
          <div class="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs font-mono text-muted">
            <p>© ${year} KaïroOS Project · Crafted with editorial precision · Open Source MIT</p>
